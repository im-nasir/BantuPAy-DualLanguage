...
export default function FeaturesSection() {
  ...
  return (
    <section className="bg-[#F7F0E7] py-16 px-4">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-4xl sm:text-5xl font-bold text-[#562315] mb-4">
          {t("title")}
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {/* Feature 1 */}
          <div className="border border-[#562315] rounded-lg p-6 text-center bg-white shadow-md">
            ...
            <p className="text-gray-600 text-sm mt-2">{t("feature1_description")}</p>
          </div>
          ...
          <div className="border border-[#562315] rounded-lg p-6 text-center bg-white shadow-md">
            ...
            <p className="text-gray-600 text-sm mt-2">{t("feature2_description")}</p>
          </div>
          ...
          <div className="border border-[#562315] rounded-lg p-6 text-center bg-white shadow-md">
            ...
            <p className="text-gray-600 text-sm mt-2">{t("feature3_description")}</p>
          </div>
          ...
          <div className="border border-[#562315] rounded-lg p-6 text-center bg-white shadow-md">
            ...
            <p className="text-gray-600 text-sm mt-2">{t("feature4_description")}</p>
          </div>
          ...
          <div className="border border-[#562315] rounded-lg p-6 text-center bg-white shadow-md">
            ...
            <p className="text-gray-600 text-sm mt-2">{t("feature5_description")}</p>
          </div>
          ...
          <div className="border border-[#562315] rounded-lg p-6 text-center bg-white shadow-md">
            ...
            <p className="text-gray-600 text-sm mt-2">{t("feature6_description")}</p>
          </div>
          ...
          <div className="border border-[#562315] rounded-lg p-6 text-center bg-white shadow-md">
            ...
            <p className="text-gray-600 text-sm mt-2">{t("feature7_description")}</p>
          </div>
          ...
          <div className="border border-[#562315] rounded-lg p-6 text-center bg-white shadow-md">
            ...
            <p className="text-gray-600 text-sm mt-2">{t("feature8_description")}</p>
          </div>
        </div>
      </div>
    </section>
